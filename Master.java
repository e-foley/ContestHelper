...
public abstract class Master
{
    ...
    public static void main(String[] args)
    {
        ...
        {        
            ...
            (new Leaderboard(history, new MemberSortVotes())).addToFile("Most votes (all-time)", "", " vote", " Votes", out, true, true, true, 1);
            (new Leaderboard(history, new MemberSortPoints())).addToFile("Most points (all-time)", "", " point", " Points", out, true, true, true, 2);
            (new Leaderboard(history, new MemberSortVotesSingle())).addToFile("Most votes (single contest, by member)", "", " votes", " Votes", out, true, true, true, 3);
            (new Leaderboard(history, new MemberSortPointsSingle())).addToFile("Most points (single contest, by member)", "", " points", " Points", out, true, true, true, 4);
            (new Leaderboard(history, new MemberSortVictories())).addToFile("Most victories", "", " victory", " Wins", out, true, true, true, 5);
            // NOTE: "Max entries" list has no details because the same information is available in the gallery.
            (new Leaderboard(history, new MemberSortEntries())).addToFile("Most participation", "", " entry", " Entries", out, true, false, true, 6);
            (new Leaderboard(history, new MemberSortConsecutiveStrict())).addToFile("Longest winning streaks (in consecutive contests, by member)", "", " streak", " Streak", out, true, true, true, 7);
            (new Leaderboard(history, new MemberSortConsecutiveLoose())).addToFile("Longest winning streaks (in consecutive attempts, by member)", "", " streak", " Streak", out, true, true, true, 8);
            (new Leaderboard(history, new MemberSortWinRatio())).addToFile("Best win ratios (minimum 5 entries)", "", "", " Ratio", out, true, true, true, 9);
            (new Leaderboard(history, new MemberSortPlusMinusPoints())).addToFile("Best plus/minus records (head-to-head vote basis)", "", "", " +/- votes", out, true, true, true, 10);
            (new Leaderboard(history, new MemberSortPlusMinusHeads())).addToFile("Best plus/minus records (head-to-head victory basis)", "", "", " +/- wins", out, true, true, true, 11);
            (new Leaderboard(history, new MemberSortNewFormidable())).addToFile("Most formidable opponents", "", "", " Rating", out, true, false, true, 12);
            ...
            out = new BufferedWriter(fstream);
            Master.addFileToBuffer("config/leaderboard_header.txt", out, swaps);
            (new Leaderboard(history, new MemberSortVotes())).addToFile("Most votes (all-time)", "", " vote", " Votes", out, false, false, true, 1, DIGEST_LIST_LENGTH);
            //(new Leaderboard(history, new MemberSortPoints())).addToFile("Most points (all-time)", "", " point", " Points", out, false, false, true, 2, DIGEST_LIST_LENGTH);
            (new Leaderboard(history, new MemberSortVotesSingle())).addToFile("Most votes (single contest, by member)", "", " votes", " Votes", out, false, true, true, 3, DIGEST_LIST_LENGTH);
            //(new Leaderboard(history, new MemberSortPointsSingle())).addToFile("Most points (single contest, by member)", "", " points", " Points", out, false, true, true, 4, DIGEST_LIST_LENGTH);
            (new Leaderboard(history, new MemberSortVictories())).addToFile("Most victories", "", " victory", " Wins", out, false, false, true, 5, DIGEST_LIST_LENGTH);
            (new Leaderboard(history, new MemberSortEntries())).addToFile("Most participation", "", " entry", " Entries", out, false, false, true, 6, DIGEST_LIST_LENGTH);
            //(new Leaderboard(history, new MemberSortConsecutiveStrict())).addToFile("Longest winning streaks (in consecutive contests, by member)", "", " streak", " Streak", out, false, true, true, 7, DIGEST_LIST_LENGTH);
            //(new Leaderboard(history, new MemberSortConsecutiveLoose())).addToFile("Longest winning streaks (in consecutive attempts, by member)", "", " streak", " Streak", out, false, true, true, 8, DIGEST_LIST_LENGTH);
            //(new Leaderboard(history, new MemberSortWinRatio())).addToFile("Best win ratios (minimum 5 entries)", "", "", " Ratio", out, false, true, true, 9, DIGEST_LIST_LENGTH);
            //(new Leaderboard(history, new MemberSortPlusMinusPoints())).addToFile("Best plus/minus records (head-to-head vote basis)", "", "", " +/- votes", out, false, false, true, 10, DIGEST_LIST_LENGTH);
            //(new Leaderboard(history, new MemberSortPlusMinusHeads())).addToFile("Best plus/minus records (head-to-head victory basis)", "", "", " +/- wins", out, false, false, true, 11, DIGEST_LIST_LENGTH);
            (new Leaderboard(history, new MemberSortNewFormidable())).addToFile("Most formidable opponents", "", "", " Rating", out, false, false, true, 12, DIGEST_LIST_LENGTH);
            Master.addFileToBuffer("config/leaderboard_footer.txt", out, swaps);
            out.close();
