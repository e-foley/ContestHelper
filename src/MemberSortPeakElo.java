...
public class MemberSortPeakElo implements MemberDataRetriever
{
    public EloEvaluator evaluator;
    
    public MemberSortPeakElo(EloEvaluator evaluator) {
        this.evaluator = evaluator;
    }
    
    public float getValue(Member member) {
        return (float)(Math.round(evaluator.getRatingDetails(member.getId()).peak_rating_after));
    }
    ...
    public Object clone() {
        return new MemberSortPeakElo((EloEvaluator)(evaluator.clone()));
    }
}